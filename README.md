...
- $\epsilon_{t-1}$ is the error from the previous time step.
- $\theta_1$ is the coefficient (parameter) that tells us how strongly the past shock affects the current value.
